...
export default function Map({
    ...
    if(aggregationTypes[aggType].breaks) {
        if(usePerCapita) {
            currentBreaks = aggregationTypes[aggType].breaks['per_capita'][indicator][boundLevel];
        } else {
            currentBreaks = aggregationTypes[aggType].breaks['totals'][indicator][boundLevel];
        }
    }
